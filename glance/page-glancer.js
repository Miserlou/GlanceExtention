...
function createGlanceBookmarklet(){
    ...
    glanceBookmarkletLoader = function() {
        ...
        getURL("https://rawgithub.com/Miserlou/GlanceExtention/master/glance/glance-bookmarklet.html", function(data){
...
function glanceBookmarkletify(input){
    ...
    for (var i=0; i<all_words.length; i++){
        ...
        if((all_words[i].indexOf(',') != -1 || all_words[i].indexOf(':') != -1 || all_words[i].indexOf('-') != -1 || all_words[i].indexOf('(') != -1|| all_words[i].length > 6) && all_words[i].indexOf('.') == -1){
